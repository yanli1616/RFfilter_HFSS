...
def series(oEditor, cpw_filter, x0=0, y0=0, var_x=0.5, var_y=0.5,
           l2=0.02, l3=0.3, d=0.001, W=0.003, W1=0.001, W2=0.002, n=8):
    l1 = (var_y - l2 - l3 - l2 - 2 * d) / 2
    
    rect = hfss.create_rectangle(oEditor, i_s(x0-var_x/2), i_s(y0), 0, i_s(var_x), i_s(var_y))
...
def shunt(oEditor, cpw_filter, x0=0, y0=0, var_x=0.5, var_y=0.5,
          l2=0.02, l3=0.447, d=0.001, W=0.003, W1=0.0011, W2=0.0017, n=8):
    l1 = (var_y - l2 - l3 - l2 - 2 * d) / 2

    rect = hfss.create_rectangle(oEditor, i_s(x0), i_s(y0-var_x/2), 0, i_s(var_y), i_s(var_x))
